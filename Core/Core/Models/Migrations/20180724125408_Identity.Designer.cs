...
namespace Core.Migrations
{
    ...
    [Migration("20180724125408_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Core.Models.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("Core.Models.Entities.Order", b =>
                {
                    b.HasOne("Core.Models.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Core.Models.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Models.Entities.StoreUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
